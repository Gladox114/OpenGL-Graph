...
void createParable(std::vector<Parable> &parableArray, float factor_a, float position, int color[3]) {
    parableArray.push_back({-10,255,-0.4,position});
}

void createParable_AtBorder() {
